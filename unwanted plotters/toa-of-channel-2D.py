...
hist =  r.TH2F('', "TOA of channel", NumberOfChannels, 0, NumberOfChannels,
        NumberOfTOAs, 0, NumberOfTOAs,)
...
hist.SetYTitle('TOA (of timestamps)')
...
c.SaveAs("plots/TOA-of-channel.pdf") 
